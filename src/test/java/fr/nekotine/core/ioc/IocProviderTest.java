...
// var provider = new IocProvider();
// var test = new TestClass("MonSuperSingleton");
// provider.registerSingletonAs(new TestClass("MonSuperSingleton2"),
// Object.class);
// provider.registerSingletonAs(test, Object.class);
// var opt = provider.tryResolve(Object.class);
// assertTrue(opt.isPresent());
...
// provider.registerTransientAs(() -> new TestClass("Transient2"),
// Object.class);
// assertNotEquals(((TestClass)a1).value,
// ((TestClass)provider.resolve(Object.class)).value);
// assertEquals("Transient2",
// ((TestClass)provider.resolve(Object.class)).value);
// }
//
// @Test
