...
public class BowCharge implements ICharge {
	...
	public BowCharge(BowChargeModule bowChargeManager, Player user, String chargeName, long duration, boolean activated,
	...
	protected boolean Update() {
		...
		if (activated && !GearUtil.HasInAnyHand(user, Material.BOW))
			cancelled = true;
		if (cancelled) {
