...
public enum DamageFunction {
	NEKOTINE(
			DamageFunction.NEKOTINE_DAMAGE_EFFECT,
			DamageFunction.NEKOTINE_DAMAGE_SOUND,
			DamageFunction.NEKOTINE_DAMAGE_KNOCKBACK,
			DamageFunction.NEKOTINE_DAMAGE_ENCHANTMENTS,
			DamageFunction.NEKOTINE_DAMAGE_ARMOR,
			DamageFunction.NEKOTINE_DAMAGE_VALIDATION,
			DamageFunction.NEKOTINE_DAMAGE_CRITICAL),
	CUSTOM(
			DamageFunction.NULL_CONSUMER, 
			DamageFunction.NULL_CONSUMER, 
			DamageFunction.NULL_CONSUMER, 
			DamageFunction.NULL_CONSUMER, 
			DamageFunction.NULL_CONSUMER, 
			DamageFunction.NULL_FUNCTION, 
			DamageFunction.NULL_TRICONSUMER);
