...
/**
 * Module synchrone pour récupérer charger et sauvegarder des cartes et leurs
 * composants
 *
...
public interface IMapModule extends IPluginModule {
	 ...
	 *
	 * @param <T>
	 *            Le type du contenu de la carte.
	 * @param metadata
	 *            La metadata de la carte.
	 * @param mapType
	 *            Le type du contenu de la carte.
