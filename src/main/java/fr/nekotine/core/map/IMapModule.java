...
public interface IMapModule {
	...
	/**
	 * Sauvegarde la metadata de la carte si elle existe.
	...
	/**
	 * Sauvegarde la structure de la carte si elle existe.
	 * @param metadata La metadata de la carte.
	 ...
	 */
	public <T> @Nullable T getContent(@Nonnull MapMetadata metadata, @Nonnull Class<T> mapType);
	
	/**
	 * Sauvegarde le contenu de la carte si elle existe.
	 * @param <T> Le type du contenu de la carte.
	 * @param metadata La metadata de la carte.
	 */
