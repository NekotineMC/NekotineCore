...
public class BlockLocationCommandGenerator extends MapElementCommandGenerator{
	...
	protected MapCommandBranch[] generateFor(Class<?> elementType) {
		...
		NekotineCore.LOGGER.info("BlockLocationCommandGenerator.generateFor utilise des messages de commande non-normalise");
