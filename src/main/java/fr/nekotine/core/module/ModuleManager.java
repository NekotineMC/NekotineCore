...
public class ModuleManager {
	...
	public <M extends IPluginModule> void load(Class<M> type) {
		...
		try (var watch = new Stopwatch(w -> logger.info("Le module "+name+" est charge ("+w.elapsedMillis()+" ms)"))){
	...
	public <M extends IPluginModule> void unload(Class<M> type) {
		...
		try (var watch = new Stopwatch(w -> logger.info("Le module "+name+" est decharge ("+w.elapsedMillis()+"ms)"))){
