...
public class ChargeModule implements IPluginModule, Listener {
	 ...
	 *
	 * @param user
	 *            Nom de l'utilisateur de la charge
	 * @param chargeName
	 *            Nom de la charge
	 * @param duration
	 ...
	 */
	public boolean AddCharge(String user, String chargeName, long duration, boolean displayOnExpBar, boolean withAudio,
			long audioBipNumber, ICharge iCharge) {
	...
	public void Tick(TickElapsedEvent e) {
		TransferBuffer();
		for (Iterator<Entry<Pair<String, String>, Charge>> iterator = charges.entrySet().iterator(); iterator
				.hasNext();) {
	...
	private void TransferBuffer() {
		for (Iterator<Entry<Pair<String, String>, Charge>> iterator = chargesBuffer.entrySet().iterator(); iterator
				.hasNext();) {
			Entry<Pair<String, String>, Charge> entry = iterator.next();
