...
public class AsyncUtil {
	...
	public static BukkitTask runAsync(Runnable runnable, Consumer<Exception> onException) {
		return Bukkit.getScheduler().runTaskAsynchronously(Ioc.resolve(JavaPlugin.class),
				AsyncUtil.catchException(runnable, onException));
	}
	...
	public static BukkitTask runSync(Runnable runnable, Consumer<Exception> onException) {
		return Bukkit.getScheduler().runTask(Ioc.resolve(JavaPlugin.class),
				AsyncUtil.catchException(runnable, onException));
	}
